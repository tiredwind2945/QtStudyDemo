...
void SlidingStackedWidget::slideInIdx(int idx, enum t_direction direction)
{
    if (idx > count()-1)
    {
       direction = m_vertical ? BOTTOM2TOP : RIGHT2LEFT;
       idx = (idx)%count();
    }
    else if(idx < 0)
    {
       direction = m_vertical ? TOP2BOTTOM: LEFT2RIGHT;
       idx = (idx+count()) % count();
    }
...
void SlidingStackedWidget::slideInWgt(QWidget * newwidget, enum t_direction direction)
{
    ...
    {
        directionhint = m_vertical ? BOTTOM2TOP : RIGHT2LEFT;
    }
    else
    {
        directionhint = m_vertical ? TOP2BOTTOM : LEFT2RIGHT;
    }
